...
namespace SpaceShooter
{
    ...
    public class MovingMeshRenderer : MonoBehaviour
    {
        ...
        [SerializeField] private MovingDirection _movingDirection = MovingDirection.moveXY;

        [SerializeField] private bool _randomDirection;

        [SerializeField] [Range(0f, 1f)] private float _xSpeed = 0.001f;

        [SerializeField] [Range(0f, 1f)] private float _ySpeed = 0.001f;
