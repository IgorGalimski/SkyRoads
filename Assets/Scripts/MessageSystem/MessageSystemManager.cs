...
namespace SpaceShooter.MessageSystem
{
    public static class MessageSystemManager
    {
        ...
        private static Dictionary<MessageType, MultitypeDelegate> _multitypeDelegates =
            new Dictionary<MessageType, MultitypeDelegate>();

        public static void AddListener<T>(MessageType messageType, EventDelegate<T> eventDelegate)
        ...
        public static void RemoveListener<T>(MessageType messageType, EventDelegate<T> eventDelegate)
            where T : IMessageData
        {
